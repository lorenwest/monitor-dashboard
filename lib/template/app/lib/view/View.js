(function(root){
  ...
  */
  var {{viewName}} = UI.app.{{shortAppName}}.{{viewName}} = Backbone.View.extend({
  ...
  *     @param options.componentView {ComponentView} The containing component view object
  */
  {{viewName}}.SettingsView = Backbone.View.extend({
