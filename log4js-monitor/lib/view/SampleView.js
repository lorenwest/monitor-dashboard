(function(root){
  ...
  */
  var SampleView = UI.app.log4js.SampleView = Backbone.View.extend({

    // Define the view
    name: 'log4jsSampleView',
    description: 'A sample view for the log4js app',
